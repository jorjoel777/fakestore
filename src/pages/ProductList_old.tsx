...
const ProductList = () => {
  ...
  const [refreshCartKey, setRefreshCartKey] = useState(0); // 👈 to trigger sidebar refresh
  ...
  const handleAddToCart = async (productId: number) => {
    ...
    setRefreshCartKey((prev) => prev + 1); // 👈 trigger cart sidebar update
  };
    ...
    <div className="flex">
      ...
      {showCart && (
        <CartSidebar
          ...
          refreshTrigger={refreshCartKey} // ✅ TRIGGERS REFRESH
        />
      )}
    </div>
  );
